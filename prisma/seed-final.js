  ...
  try {
    ...
    const course = await prisma.course.create({
      data: {
        language: 'hindi',
        level: 'a1',
        title: 'हिंदी - A1 शुरुआती',
        description: 'Khóa học tiếng Hindi cơ bản A1 cho người mới bắt đầu',
        isPublished: true,
        order: 14,
      }
    })
    ...
    const lesson = await prisma.lesson.create({
      data: {
        ...
        description: 'Học cách chào hỏi cơ bản trong tiếng Bồ Đào Nha',
    ...
    const grammar = await prisma.grammar.create({
      data: {
        pattern: 'Eu sou + [profissão]',
        explanation: 'Cấu trúc cơ bản để giới thiệu nghề nghiệp: Tôi là + [nghề nghiệp]',
        examples: 'Eu sou estudante, Eu sou professor',
        lessonId: lesson.id,
      }
    })
